        ...
        <>
            {
                carts?.length > 0 ? <div>{
                    ...
                    <button className='flex ms-auto border rounded-xl mt-3 py-3 px-7 text-lg font-bold bg-green-200 hover:bg-green-300 hover:scale-95 transition-all'>Ödemeye Geç</button>
                    ...
                    <button className=' border p-4 text-xl font-bold rounded-lg hover:scale-95 hover:bg-gray-300 bg-gray-200 transition-all' onClick={() => navigate(`/`)}>Ürünler Sayfasına Git</button>
                </div>
            }
            <SimilarProducts />
        </>
